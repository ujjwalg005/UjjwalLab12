    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TabLayoutMediator(ujjTabLayout, ujjViewPager,
                (tab, position) -> {
                    switch (position) {
                        case 0:
                            tab.setText(getString(R.string.ujj_tab1_name));
                            tab.setIcon(R.drawable.ic_home);
                            break;
                        case 1:
                            tab.setText(getString(R.string.ujj_tab2_name));
                            tab.setIcon(R.drawable.ic_cart);
                            break;
                        case 2:
                            tab.setText(getString(R.string.ujj_tab3_name));
                            tab.setIcon(R.drawable.ic_truck);
                            break;
                        case 3:
                            tab.setText(getString(R.string.ujj_tab4_name));
